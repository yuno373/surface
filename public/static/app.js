...
async function testPush(){try{const r=await api('/api/admin/notifications/test',{method:'POST'});if(r.error){toast(r.error,'error');return;}toast(r.message,'success');}catch(e){toast('失敗: '+(e.message||'エラー'),'error');}}
